...
description: >-
  ...
  (app-runner, report-visualist, codebase-scout, web-researcher, os-monitor) to diagnose and
...
- os-monitor: monitors operating system resources and logs.
